...
const SignUp = () => {
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div>
      ...
      <div>
        <div className="flex items-center justify-between">
          <label for="comfirm-password" className="block text-sm font-medium leading-6 text-gray-900">Confirm Password</label>
        </div>
        <div className="mt-2">
          <input id="comfirm-password" name="comfirm-password" type="password" autocomplete="comfirm-password" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
        </div>
      </div>
