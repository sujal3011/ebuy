...
export default function Page({cart,addToCart,removeFromCart,clearCart,cartPrice}) {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto object-cover object-top rounded px-20" src="/images/men-tshirt.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <span className="title-font font-medium text-2xl text-gray-900 my-2">$58.00</span>
        ...
        <div className="flex justify-start">
          ...
          <button className="flex mx-2 text-white bg-cyan-500 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-600 rounded" onClick={()=>{addToCart(slug,1,499,'summer Tshirt','XL','Red')}}>Add to Cart</button>
