...
const HomePage = () => {
  return (
    <div>
      ...
      <Image src='/images/home-image1.jpg'  fill={true} alt='homepage-image' />
      </div>

        <section className="text-cyan-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4">
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          <h3 className="text-cyan-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 className="text-cyan-900 title-font text-lg font-medium">The Catalyzer</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          <h3 className="text-cyan-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 className="text-cyan-900 title-font text-lg font-medium">Shooting Stars</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          <h3 className="text-cyan-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 className="text-cyan-900 title-font text-lg font-medium">Neptune</h2>
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          <h3 className="text-cyan-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 className="text-cyan-900 title-font text-lg font-medium">The 400 Blows</h2>
